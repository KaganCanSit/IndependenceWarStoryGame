    ...
    public void HandleInputData(int val)
    {
        ...
        else if(val == 2)
        {
            ...
            ChangeTextLang("OYUNU OYNA", "OYUN SEC", "SECENEKLER", "HAKKINDA", "CIKIS",
                           "SES", "DIL", "ZORLUK", "MENUYE DON", "Kurtuluş Savaşı Hikayeleri", "Bu oyun Ömer Faruk Yılmaz ve Kağan Can Şit tarafından çocukların tarihi değerlerimizi fark etmesini sağlamak ve Kurtuluş Savaşı değerlerimizi yaþatmak adına yapılmıştır.\n\nHiç bir ticari hedef ve doðrultusu olmamak ile birlikte izinsiz þekilde kopyalanması, dağıtılması ve satışa sunulması yasaktır.Bizler için ileriye dönük ve geliştirmeye açık bir proje olarak yerine sürdürmeye devam edicektir.\nBu doðrultuda katkıda bulunmak ve öğrenmemize yardım etmek isteyenlerin Github hesaplarımızı aşağıya bırakıyoruz.\n\nhttps://github.com/OmerFarukYilmaz-github\nhttps://github.com/KaganCanSit\n\n\nÞimdiden teþekkür ederiz.", "MENUYE DON");
        }
    }
